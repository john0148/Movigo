 ...
 * 
 * Hiển thị banner phim nổi bật ở đầu trang chủ.
 * Bao gồm:
 * - Ảnh nền lớn của phim
 * - Tiêu đề phim
 * - Mô tả ngắn gọn
 * - Các nút: "Xem phim" và "Thông tin thêm"
 */
...
function FeaturedBanner({ movie, onWatch }) {
  ...
  const backgroundImage = movie.backdrop_url || movie.poster_url;
    ...
    <div className="featured-banner">
      ...
      <div className="banner-content">
        ...
        <div className="banner-metadata">
          ...
          <span className="movie-duration">{movie.duration_minutes} phút</span>
          {movie.rating && (
            <>
              <span className="metadata-separator">•</span>
